...
const ProductSummary = (props) => {
    ...
    const { brand, title, info, category, type, connectivity,feature1,feature2,feature3,overview_title,overview_description} = props;
                    ...
                    <div className="prod_summary_details">
                        {
                            active === 'specs' ? (
                                ...
                                <div className="prod_overview">
                                    <h3>The <span>{title}</span> {info} {overview_title}</h3>
                                    <ul>
                                        <li>{feature1}</li>
                                        <li>{feature2}</li>
                                        <li>{feature3}</li>
